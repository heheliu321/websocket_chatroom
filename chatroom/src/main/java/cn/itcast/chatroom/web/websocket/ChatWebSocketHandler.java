...
import cn.itcast.chatroom.web.controller.ChatController;
...
public class ChatWebSocketHandler implements WebSocketHandler
{
     ...
     */
    private void sendMessageToUser(String name, TextMessage message) throws IOException
    {
        //获取到要接收消息的用户的session
        String userId = ChatController.usersMap.get(name);
        WebSocketSession webSocketSession = USER_SOCKETSESSION_MAP.get(userId);
